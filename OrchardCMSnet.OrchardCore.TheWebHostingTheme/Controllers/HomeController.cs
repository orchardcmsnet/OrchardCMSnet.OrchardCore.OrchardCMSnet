...
using TheWebHostingTheme.ViewModels;

namespace OrchardCore.ThePaperKit2Theme.Controllers
{
    public class HomeController : Controller
    {
        private const string defaultAdminName = "admin";
        private const string dataProtectionPurpose = "Password";
        private const string emailSubject = "ThePaperKit2Theme Registration";
